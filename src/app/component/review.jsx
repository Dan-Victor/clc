    ...
    <div className='relative w-auto mt-[60px] grid gap-6  justify-center sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3'>
       {
        Reviews.slice(0,3).map((review,index)=>(
             <div className='w-auto relative flex justify-center items-center h-[430px]'>
           <div key={index} className=" w-[330px] md:w-[459px] px-6 border-2 bg-[#F9FAFB] relative border-[#E5E7EB] text-[#4B5564] rounded-xl pt-[80px] h-auto pb-8" >
