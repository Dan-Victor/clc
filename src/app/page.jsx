...
const impacts = [
 ...
 return (
    <div className="max-w-380 font-mont ">
    <Header/>
   
     <section className='xl:grid-cols-2 grid justify-between items-center pt-[150px] mx-5 md:mx-11 gap-[20px] xl:gap-[270px]'>
      ...
      <h1 className=' lg:text-[40px] text-[#AD8E63] md:w-[85%] xl:text-left text-center xl:w-full mt-4  md:mt-6 md:text-[30px]  text-[20px] font-bold'>Empowering <span className='text-black'>Communities,</span> Shaping <span className="text-black">Leaders</span></h1>
      ...
      <Image src='/cclchero.jpg' alt='community img' width={579} height={565} className=''/>
      </div>
     </section>
  ...
  />}
     ...
     <section className='md:px-11 px-5  w-full h-auto py-[72px] bg-[#ffffff] text-black flex flex-col justify-center items-center'>
     ...
     <section className='w-full h-auto text-center text-[#4B5564] flex justify-center items-center flex-col bg-[#ffff] py-[72px]'>
       ...
       <div className="grid xl:grid-cols-2   sm:grid-cols-1 mt-8 gap-6">
        <div className='  md:w-[620px] w-[330px] h-auto  md:h-[404px] py-8 px-6 text-white bg-[#0f4082] rounded-[12px]'>
          <h1 className='text-white font-bold md:text-[40px] text-[30px] pb-6 '>Our Mission</h1>
          <h2 className="text-left">To develop and empower community leaders through innovative programs, strategic partnerships, and sustainable initiates that create lasting positive change in communities worldwide.</h2>
         ...
         <div className='md:w-[620px] h-auto md:h-[404px] w-[330px] py-8 px-6 text-white bg-[#AD8E63] rounded-[12px]'>
          <h1 className='text-white font-bold md:text-[40px] text-[30px] pb-6'>Our Vision</h1>
          <h2 className="text-left">To be the catalyst for a global network of empowered communities where every individual has the opportunity to lead, contribute, and thrive in an inclusive environment.</h2>
     ...
     <section className='py-[72px] px-[25px] flex flex-col justify-center items-center'>
        ...
        <div className=' xl:w-[60%] w-[95%] bg-[#0F4082] text-center flex justify-center items-center rounded-xl mt-[48px] flex-col py-8 px-[52px] gap-[24px] h-auto'>
          <h1 className='md:text-[40px] text-[30px] font-bold'>Ready to Add Your Voice?</h1>
    ...
    <h1 className='md:text-[40px] text-[30px] font-bold'>Ready to Make Your Impact?</h1>
    ...
    <div className='flex justify-center mt-[56px]  gap-[10px] md:gap-[84px] items-start md:items-center'>
      {
        impacts.map((impact,index)=>(
          <div key={index} className='flex flex-col justify-center items-center'>
            ...
            <h1 className=' py-4 text-2xl font-bold'>{impact.header}</h1>
